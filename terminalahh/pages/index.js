...
const exampleData = [
    ...
    },
    {
        ...
        height: 163,
        image:
        "https://scontent.fuln1-2.fna.fbcdn.net/v/t1.15752-9/483420383_1009396897917015_8573609397208042043_n.jpg?stp=dst-jpg_s600x600_tt6&_nc_cat=100&ccb=1-7&_nc_sid=0024fc&_nc_ohc=fmB0BVTRuTYQ7kNvgE8ef3G&_nc_oc=AdiCjAx0yrmeaQouPiHusuS88tiYQ0wmp-7ImoGKgNAiz1ivDom1sNrgmsZgJE6uJzU&_nc_ad=z-m&_nc_cid=0&_nc_zt=23&_nc_ht=scontent.fuln1-2.fna&oh=03_Q7cD1wGeRUmhzJKYDA7AOxfQqGbd_JNA3jPCle7x1XXI_i2Taw&oe=67FA651E"
    },
    {
        id: 9,
            ...
            <div className={`grid ${isRow ? 'grid-cols-1' : 'lg:grid-cols-5 md:grid-cols-2 sm:grid-cols-1'} gap-10 justify-items-center`}>
                {filteredData.length > 0 ? (
                    filteredData.map((element) => (
                        <div
                            key={element.id}
                            className="flex flex-col items-center p-6 bg-gray-500 rounded-2xl border border-gray-800 hover:scale-105 transition-transform duration-300 ease-in-out"
                        >
                            <img
                                src={element.image}
                                alt={element.firstname}
                                className="rounded-lg w-40 h-40 object-fit"
                            />
